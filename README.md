...
> **Status:** in active development. Geometry, text/Tex, coordinate systems, functions, and the animation system render in the browser today; see [`progress.md`](./progress.md) for what's done vs. pending and [`docs/`](./docs/README.md) for the migration plan.
